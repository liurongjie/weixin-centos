# Generated by Django 2.0.9 on 2019-03-21 01:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(1, '健身'), (2, '驾校'), (3, '考研'), (4, '小语种')], verbose_name='产品类别')),
                ('period', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dajia.Period')),
            ],
        ),
        migrations.CreateModel(
            name='Production',
            fields=[
                ...
                ('type', models.IntegerField(choices=[(1, '健身'), (2, '驾校'), (3, '考研'), (4, '小语种')], verbose_name='产品类别')),
                ('merchant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dajia.Merchant')),
            ],
        ),
        migrations.CreateModel(
            name='Steam',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(0, '为实名认证'), (1, '实名认证通过')], verbose_name='是否完成实名认证')),
                ('team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dajia.Team')),
            ],
        ),
        migrations.AddField(
            model_name='periodtoteam',
            name='team',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dajia.Team'),
        ),
        migrations.AddField(
            model_name='period',
            name='production',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dajia.Production'),
        ),
        migrations.AddField(
            model_name='order',
            name='period',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dajia.Period'),
        ),
        migrations.AddField(
            model_name='order',
            name='production',
        ...
        migrations.AddField(
            model_name='order',
            name='steam',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dajia.Steam'),
        ),
        migrations.AddField(
            model_name='order',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dajia.User'),
        ),
        migrations.AddField(
            model_name='cutting',
            name='audience',
        ...
        migrations.AddField(
            model_name='comment',
            name='order',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dajia.Order'),
        ),
        migrations.AddField(
            model_name='comment',
            name='production',
